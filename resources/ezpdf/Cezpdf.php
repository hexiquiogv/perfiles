 ...
 */
 class Cezpdf extends Cpdf {
    ...
    const JUSTIFICADO = ['justification' => 'full'];
    const IZQUIERDA = ['justification' => 'left'];
    const DERECHA = ['justification' => 'right'];
    const CENTRADO = ['justification' => 'center'];
