...
<div class="m-2 p-1">
    <div class="card col-md-12 badge badge-light">
        <div class="d-flex flex-row mx-2 mt-2 mb-1">
            <div class="h4 pt-1">Agregar Poliza de Seguro</div>
            <div class="pt-1">
                <a href="{{route('seguros.create')}}" 
                    class="text-success text-capitalize mx-2 justify-vertical" 
                    style="margin-top: -2px;" title='Agregar Poliza de Seguro'>
    ...
    <div class="card-block">            
        <div id="table-container" class="p-3 col-12">
            ...
            id="seguros_table" data-form="deleteForm">
                <thead class="">
                    <tr>
                        <th>Id</th>                        
                        <th>UUID</th>
...
@include ('layouts.partials.modal.confirm_deletion',['route'=>'seguros',
...
@push('scripts2')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var seguros_table = $('#seguros_table').DataTable({
                // autoWidth: false,
                responsive: !0,
                select: !0,
                searching: true,
        ...
        $("#search").on('keyup', function() {
            $("#seguros_table").DataTable().search( this.value ).draw();
        });
    </script>
@endpush