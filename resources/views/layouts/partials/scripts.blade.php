<script>
    ...
    var lang = 
        {
            ...
            "sInfoFiltered":   " filtrados (Total _MAX_)",
            "sInfoPostFix":    "",
            "sSearch":         "Buscar:",
            "sUrl":            "",
            "sInfoThousands":  ",",
    ...
    function dynamicCheckboxes(url, id = null, container, type = null, 
        style = null, otro = null, exclude=null){
        ...
        $.post(url, data, function(result){
            ...
            if(result.status === 'ok'){
                ...
                $.each(result.data, function(i, item) {
                    let checked = checked_ids.includes(item.id);
                    //console.log(item.id);

                    if (checked & "exclude" == exclude) { return true; }
                    if (!checked & "include" == exclude) { return true; }
