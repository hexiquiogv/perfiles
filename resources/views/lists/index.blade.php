...
<div class="container">
    <div class="card col-md-12 badge badge-light">
        <div class="d-flex flex-row mx-2 mt-2 mb-1">
            <div class="h4 pt-1">Agregar {{__("messages.$name")}}</div>
            <div class="pt-1">
                <a href="{{$route}}" class="text-success text-capitalize mx-2 justify-vertical" 
                    style="margin-top: -2px;" title='Agregar {{__("messages.$name")}}'>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var catalogos_table = $('#catalogos_table').DataTable({
                ...
                //scrollX: false,
                columns: [
                    {data:'id', name:'id', searchable:false, orderable:true, width:'10%'},
