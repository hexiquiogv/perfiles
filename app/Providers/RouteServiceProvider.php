        ...
        $this->routes(function () {
            ...
            Route::middleware('web')
                ...
                ->group(function($router) {
                    ...
                    require base_path('routes/medias.php');
